...
#! @Arguments object
@DeclareFilter( "IsLeftOrRightPresentation",
                 IsCapCategoryObject );
...
#! @Arguments object
@DeclareFilter( "IsLeftPresentation",
...
#! @Arguments object
@DeclareFilter( "IsRightPresentation",
                 IsLeftOrRightPresentation );
...
@DeclareOperation( "INTERNAL_HOM_EMBEDDING_IN_TENSOR_PRODUCT_LEFT",
                           [ IsLeftOrRightPresentation, IsLeftOrRightPresentation ] );

@DeclareOperation( "INTERNAL_HOM_EMBEDDING_IN_TENSOR_PRODUCT_RIGHT",
                           [ IsLeftOrRightPresentation, IsLeftOrRightPresentation ] );
